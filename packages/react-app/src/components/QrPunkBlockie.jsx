...
export default function QRPunkBlockie(props) {
  ...
  return (
    <div
      style={{
        width: punkSize * props.scale ?? 1,
        height: punkSize * props.scale ?? 1,
      }}
    >
      <div
        style={{
          ...
          console.log(
            <span style={{ position: "relative" }}>
              ...
              <div style={{ position: "absolute", left: -60, top: -14 }}>
                <div
                  style={{ position: "relative", width: iconPunkSize, height: iconPunkSize - 1, overflow: "hidden" }}
                >
                  <img
                    alt="avatar punk"
                    src="/punks.png"
      ...
      >
        ...
        >
          <Blockies seed={props.address.toLowerCase()} scale={punkSize / 8} />
        </div>
